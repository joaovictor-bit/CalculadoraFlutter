...
class _MediaEscolarPageState extends State<MediaEscolarPage>{
  ...
  void calcularMedia(){
    ...
    if(
      nome.isEmpty || nota1 == null || nota2 == null || nota3 == null  || nota4 == null
      ){
    ...
    if(
      nota1 < 0  ||nota1 > 10 || nota2 < 0  || nota2 > 10 || nota3 < 0 || nota3 > 10 || nota4 > 10 || nota4 < 0 
    ){
